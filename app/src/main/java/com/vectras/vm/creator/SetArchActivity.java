...
//        UIUtils.setOnApplyWindowInsetsListener(findViewById(R.id.main));
        ...
        binding.archOpencoreMacos.setOnClickListener(this);
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.archi386) {
            ...
            startActivity(new Intent(activity, VMCreatorActivity.class));
            finish();
        } else if (id == R.id.arch_opencore_macos) {
            MainSettingsManager.setArchX86_64(this);

            Intent intent = new Intent(activity, VMCreatorActivity.class);
            intent.putExtra("template", "opencore_catalina");
            intent.putExtra("romname", "macOS Catalina");
            startActivity(intent);
            finish();
